...
const cakeNameIdElementId = "cakeName";
...
(async function loadCake() {
    ...
    try {
        ...
        document.getElementById(cakeNameIdElementId)
            .textContent = cake.name;

        document.getElementById(cakeDescriptionElementId)
            .textContent = cake.description;

        document.getElementById(cakeUnitPriceElementId)
            .textContent = cake.price.toFixed(2);
